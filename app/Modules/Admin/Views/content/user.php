                    ...
                    <table id="datatablesSimple">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="avatar me-2"><img class="avatar-img img-fluid" src="<?= base_url() ?>assets/img/illustrations/profiles/profile-1.png" /></div>
                                        Tiger Nixon
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="avatar me-2"><img class="avatar-img img-fluid" src="<?= base_url() ?>assets/img/illustrations/profiles/profile-2.png" /></div>
                                        Garrett Winters
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="avatar me-2"><img class="avatar-img img-fluid" src="<?= base_url() ?>assets/img/illustrations/profiles/profile-3.png" /></div>
                                        Ashton Cox
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="avatar me-2"><img class="avatar-img img-fluid" src="<?= base_url() ?>assets/img/illustrations/profiles/profile-4.png" /></div>
                                        Cedric Kelly
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="avatar me-2"><img class="avatar-img img-fluid" src="<?= base_url() ?>assets/img/illustrations/profiles/profile-5.png" /></div>
                                        Airi Satou
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="avatar me-2"><img class="avatar-img img-fluid" src="<?= base_url() ?>assets/img/illustrations/profiles/profile-6.png" /></div>
                                        Brielle Williamson
                                    </div>
                                </td>
