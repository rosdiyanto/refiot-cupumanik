                    ...
                    <div class="card mb-4">
                        <div class="card-body py-5">
                            <div class="d-flex flex-column justify-content-center">
                                <img class="img-fluid mb-4" src="<?= base_url() ?>assets/img/illustrations/data-report.svg" alt="" style="height: 10rem" />
                ...
                <div class="col-xxl-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-4">
                                        <div class="d-flex align-items-center flex-shrink-0 me-3">
                                            <div class="avatar avatar-xl me-3 bg-gray-200"><img class="avatar-img img-fluid" src="<?= base_url() ?>assets/img/illustrations/profiles/profile-1.png" alt="" /></div>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-4">
                                        <div class="d-flex align-items-center flex-shrink-0 me-3">
                                            <div class="avatar avatar-xl me-3 bg-gray-200"><img class="avatar-img img-fluid" src="<?= base_url() ?>assets/img/illustrations/profiles/profile-2.png" alt="" /></div>
                                            <div class="d-flex flex-column fw-bold">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-4">
                                        <div class="d-flex align-items-center flex-shrink-0 me-3">
                                            <div class="avatar avatar-xl me-3 bg-gray-200"><img class="avatar-img img-fluid" src="<?= base_url() ?>assets/img/illustrations/profiles/profile-3.png" alt="" /></div>
                                            <div class="d-flex flex-column fw-bold">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-4">
                                        <div class="d-flex align-items-center flex-shrink-0 me-3">
                                            <div class="avatar avatar-xl me-3 bg-gray-200"><img class="avatar-img img-fluid" src="<?= base_url() ?>assets/img/illustrations/profiles/profile-4.png" alt="" /></div>
                                            <div class="d-flex flex-column fw-bold">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mb-4">
                                        <div class="d-flex align-items-center flex-shrink-0 me-3">
                                            <div class="avatar avatar-xl me-3 bg-gray-200"><img class="avatar-img img-fluid" src="<?= base_url() ?>assets/img/illustrations/profiles/profile-5.png" alt="" /></div>
                                            <div class="d-flex flex-column fw-bold">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="d-flex align-items-center flex-shrink-0 me-3">
                                            <div class="avatar avatar-xl me-3 bg-gray-200"><img class="avatar-img img-fluid" src="<?= base_url() ?>assets/img/illustrations/profiles/profile-6.png" alt="" /></div>
                                            <div class="d-flex flex-column fw-bold">
                    ...
                    <div class="card">
                        <div class="card-body text-center p-5">
                            <img class="img-fluid mb-4" src="<?= base_url() ?>assets/img/illustrations/team-spirit.svg" alt="" style="max-width: 16.25rem" />
                            <h5>Team Access</h5>
